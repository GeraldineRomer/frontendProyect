    ...
    return (
        <Box sx={{ width: '100%' }}>
            ...
            <CustomTabPanel value={value} index={0}>
                ...
                voluntaria mis Datos Personales, que he leído y aceptado estos términos y condiciones de manera previa y autorizo a Cosmonotas de Colombia S.A.S., para que, como Responsable, realice la recolección y tratamiento de mis datos personales para las finalidades indicadas más adelante y de conformidad con la Política de tratamiento de la información de MCOL
            </CustomTabPanel>
            <CustomTabPanel value={value} index={1}>
                <div> 
                    Cosmonotas de Colombia S.A.S. no otorga premios o realiza juegos promocionales relacionados con sus articulos. Por tanto, se advierte a los clientes, prospectos y al público en general que la compañía no es promotora, anunciante ni avala ninguna promoción de esta naturaleza, particularmente aquellas que puedan ser enviadas a través de mensajes SMS o de cualquier otro medio con enlaces a nuestro Sitio Web.
                </div>
                <div>
                    En caso recibir este tipo de mensaje, debe tener en cuenta que se trata de una actividad no autorizada por nuestra marca y posiblemente fraudulenta. De recibir este tipo de mensajes, puede contactarnos al Teléfono: (+57) 3017457749, al correo electrónico: servicioalcliente@cosmonotas.co. 
                </div>
                <div>
            ...
            <CustomTabPanel value={value} index={2}>
                <div>
                    De conformidad con lo dispuesto en la Ley 1581 de 2012 y el Decreto 1377 de 2013, declaro que entrego de forma libre y voluntaria mis Datos Personales y con mi aceptación y/o firma autorizo a Cosmonotas de Colombia S.A.S., para que, como Responsable, realice Ia recolección y tratamiento de mis datos personales para las finalidades indicadas más adelante y de conformidad con la Política de tratamiento de la información de MCOL
                </div>
                <div>
